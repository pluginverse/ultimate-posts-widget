...
class WP_Widget_Ultimate_Posts extends WP_Widget
{
    ...
    function flush_admin_notice__warning()
    {
        ...
        if (version_compare($wp_version, '5.8') >= 0 && ! is_plugin_active('classic-widgets/classic-widgets.php')) {
          ...
          <div class="notice notice-warning upw-notice-wrapper is-dismissible">
            <p><?php
                echo sprintf(
                    __('%1$sUltimate Posts Widget:%2$s This plugin provides a classic widget type, and needs the %3$sClassic Widgets%4$s plugin to function properly on this WordPress version.',
    ...
    function enqueue_admin_scripts()
    {
        ...
        wp_register_script('upw_admin_scripts', plugins_url('js/upw-admin.min.js', __FILE__), array('jquery'), null,
            true);
    ...
    function widget($args, $instance)
    {
        ...
        if (($instance['template'] ?? '') === 'custom') {
            $custom_template_path = apply_filters('upw_custom_template_path',
                '/upw/'.$instance['template_custom'].'.php', $instance, $this->id_base);
    ...
    function form($instance)
    {
      ...
      <div class="upw-tabs">
        <a class="upw-tab-item active" data-toggle="upw-tab-general"><?php _e('General',
                'ultimate-posts-widget'); ?></a>
      ...
      <div class="upw-tab upw-tab-general">
        ...
        <p>
          <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'ultimate-posts-widget'); ?>
            :</label>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('title_link'); ?>"><?php _e('Title URL',
                  'ultimate-posts-widget'); ?>:</label>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('class'); ?>"><?php _e('CSS class', 'ultimate-posts-widget'); ?>
            :</label>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('before_posts'); ?>"><?php _e('Before posts',
                  'ultimate-posts-widget'); ?>:</label>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('after_posts'); ?>"><?php _e('After posts',
                  'ultimate-posts-widget'); ?>:</label>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('custom_empty'); ?>"><?php _e('No posts found message',
                  'ultimate-posts-widget'); ?>:</label>
          <input class="widefat" id="<?php echo $this->get_field_id('custom_empty'); ?>"
                 name="<?php echo $this->get_field_name('custom_empty'); ?>" type="text"
                 value="<?php echo esc_attr($custom_empty); ?>" placeholder="No posts found."/>
        </p>
      ...
      <div class="upw-tab upw-hide upw-tab-display">
        ...
        <p>
          <label for="<?php echo $this->get_field_id('template'); ?>"><?php _e('Template', 'ultimate-posts-widget'); ?>
            :</label>
          <select name="<?php echo $this->get_field_name('template'); ?>"
                  id="<?php echo $this->get_field_id('template'); ?>" class="widefat">
            <option value="legacy"<?php if ($template == 'legacy') {
                echo ' selected';
            } ?>><?php _e('Legacy', 'ultimate-posts-widget'); ?></option>
            <option value="standard"<?php if ($template == 'standard') {
                echo ' selected';
            } ?>><?php _e('Standard', 'ultimate-posts-widget'); ?></option>
            <option value="custom"<?php if ($template == 'custom') {
                echo ' selected';
            } ?>><?php _e('Custom', 'ultimate-posts-widget'); ?></option>
          </select>
        </p>

        <p<?php if ($template !== 'custom') {
            echo ' style="display:none;"';
        } ?>>
          <label for="<?php echo $this->get_field_id('template_custom'); ?>"><?php _e('Custom Template Name',
                  'ultimate-posts-widget'); ?>:</label>
          <input class="widefat" id="<?php echo $this->get_field_id('template_custom'); ?>"
                 ...
                 value="<?php echo esc_attr($template_custom); ?>"/>
        </p>

        <p>
          <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of posts',
                  'ultimate-posts-widget'); ?>:</label>
        ...
        <p>
          ...
          <label for="<?php echo $this->get_field_id('show_title'); ?>"><?php _e('Show title',
                  'ultimate-posts-widget'); ?></label>
        </p>

        <p>
          <input class="box" id="<?php echo $this->get_field_id('show_date'); ?>"
                 name="<?php echo $this->get_field_name('show_date'); ?>"
                 type="checkbox" <?php checked((bool) $show_date, true); ?> />
          <label for="<?php echo $this->get_field_id('show_date'); ?>"><?php _e('Show published date',
                  'ultimate-posts-widget'); ?></label>
        </p>
        ...
        <p<?php if ( ! $show_date) {
          ...
          <label for="<?php echo $this->get_field_id('date_format'); ?>"><?php _e('Date format',
                  'ultimate-posts-widget'); ?>:</label>
        ...
        <p>
          ...
          <label for="<?php echo $this->get_field_id('show_author'); ?>"><?php _e('Show post author',
                  'ultimate-posts-widget'); ?></label>
        </p>
        ...
        <p>
          ...
          <label for="<?php echo $this->get_field_id('show_comments'); ?>"><?php _e('Show comments count',
                  'ultimate-posts-widget'); ?></label>
        </p>

        <p>
          <input class="checkbox" id="<?php echo $this->get_field_id('exclude_current'); ?>"
                 name="<?php echo $this->get_field_name('exclude_current'); ?>"
                 type="checkbox" <?php checked((bool) $exclude_current, true); ?> />
          <label for="<?php echo $this->get_field_id('exclude_current'); ?>"><?php _e('Exclude current post from the list',
                  'ultimate-posts-widget'); ?></label>
        </p>
        ...
        <p>
          ...
          <label for="<?php echo $this->get_field_id('show_excerpt'); ?>"><?php _e('Show excerpt',
                  'ultimate-posts-widget'); ?></label>
        </p>
        ...
        <p<?php if ( ! $show_excerpt) {
          ...
          <label for="<?php echo $this->get_field_id('excerpt_length'); ?>"><?php _e('Excerpt length (in words)',
                  'ultimate-posts-widget'); ?>:</label>
          <input class="widefat" type="number" id="<?php echo $this->get_field_id('excerpt_length'); ?>"
                 ...
                 value="<?php echo esc_attr($excerpt_length); ?>" min="-1"/>
        </p>
        ...
        <p>
          ...
          <label for="<?php echo $this->get_field_id('show_content'); ?>"><?php _e('Show content',
                  'ultimate-posts-widget'); ?></label>
        </p>

        <p<?php if ( ! $show_excerpt && ! $show_content) {
            echo ' style="display:none;"';
        } ?>>
          <label for="<?php echo $this->get_field_id('show_readmore'); ?>">
            <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id('show_readmore'); ?>"
                   name="<?php echo $this->get_field_name('show_readmore'); ?>"<?php checked((bool) $show_readmore,
                true); ?> />
              <?php _e('Show read more link', 'ultimate-posts-widget'); ?>
          </label>
        </p>

        <p<?php if ( ! $show_readmore || ( ! $show_excerpt && ! $show_content)) {
            echo ' style="display:none;"';
        } ?>>
          <input class="widefat" type="text" id="<?php echo $this->get_field_id('excerpt_readmore'); ?>"
                 ...
                 value="<?php echo esc_attr($excerpt_readmore); ?>"/>
        </p>
        ...
        <p>
          ...
          <label for="<?php echo $this->get_field_id('show_cats'); ?>"> <?php _e('Show post categories',
                  'ultimate-posts-widget'); ?></label>
        </p>
        ...
        <p>
          ...
          <label for="<?php echo $this->get_field_id('show_tags'); ?>"> <?php _e('Show post tags',
                  'ultimate-posts-widget'); ?></label>
        </p>

        <p>
          <label for="<?php echo $this->get_field_id('custom_fields'); ?>"><?php _e('Show custom fields (comma separated)',
                  'ultimate-posts-widget'); ?>:</label>
      ...
      <div class="upw-tab upw-hide upw-tab-filter">
        ...
        <p>
          ...
          <label for="<?php echo $this->get_field_id('atcat'); ?>"> <?php _e('Show posts only from current category',
                  'ultimate-posts-widget'); ?></label>
        </p>

        <p>
          <label for="<?php echo $this->get_field_id('cats'); ?>"><?php _e('Categories', 'ultimate-posts-widget'); ?>
            :</label>
          <select name="<?php echo $this->get_field_name('cats'); ?>[]" id="<?php echo $this->get_field_id('cats'); ?>"
                  class="widefat" style="height: auto;" size="<?php echo $c ?>" multiple>
            <option value="" <?php if (empty($cats)) {
              ...
              foreach ($categories as $category) { ?>
                <option value="<?php echo esc_attr($category->term_id); ?>" <?php if (is_array($cats) && in_array($category->term_id,
                        $cats)) {
                    echo 'selected="selected"';
          ...
          <?php if ($tag_list) : ?>
            <p>
              ...
              <label for="<?php echo $this->get_field_id('attag'); ?>"> <?php _e('Show posts only from current tag',
                      'ultimate-posts-widget'); ?></label>
            </p>

            <p>
              <label for="<?php echo $this->get_field_id('tags'); ?>"><?php _e('Tags', 'ultimate-posts-widget'); ?>
                :</label>
              <select name="<?php echo $this->get_field_name('tags'); ?>[]"
                ...
                <option value="" <?php if (empty($tags)) {
                    echo 'selected="selected"';
                } ?>><?php _e('&ndash; Show All &ndash;') ?></option>
                  <?php
                  foreach ($tag_list as $tag) { ?>
                    <option value="<?php echo esc_attr($tag->term_id); ?>" <?php if (is_array($tags) && in_array($tag->term_id,
                            $tags)) {
                        echo 'selected="selected"';
        ...
        <p>
          <label for="<?php echo $this->get_field_id('types'); ?>"><?php _e('Post types', 'ultimate-posts-widget'); ?>
            :</label>
          <select name="<?php echo $this->get_field_name('types'); ?>[]"
            ...
            <option value="" <?php if (empty($types)) {
                echo 'selected="selected"';
            } ?>><?php _e('&ndash; Show All &ndash;') ?></option>
              <?php
              ...
              foreach ($post_types as $post_type) { ?>
                <option value="<?php echo esc_attr($post_type); ?>" <?php if (is_array($types) && in_array($post_type,
                        $types)) {
                    echo 'selected="selected"';
        ...
        <p>
          <label for="<?php echo $this->get_field_id('sticky'); ?>"><?php _e('Sticky posts',
                  'ultimate-posts-widget'); ?>:</label>
          <select name="<?php echo $this->get_field_name('sticky'); ?>"
                  id="<?php echo $this->get_field_id('sticky'); ?>" class="widefat">
            <option value="show"<?php if ($sticky === 'show') {
                echo ' selected';
            } ?>><?php _e('Show All Posts', 'ultimate-posts-widget'); ?></option>
            <option value="hide"<?php if ($sticky == 'hide') {
                echo ' selected';
            } ?>><?php _e('Hide Sticky Posts', 'ultimate-posts-widget'); ?></option>
            <option value="only"<?php if ($sticky == 'only') {
                echo ' selected';
            } ?>><?php _e('Show Only Sticky Posts', 'ultimate-posts-widget'); ?></option>
          </select>
        </p>
      ...
      <div class="upw-tab upw-hide upw-tab-order">
        ...
        <p>
          <label for="<?php echo $this->get_field_id('orderby'); ?>"><?php _e('Order by', 'ultimate-posts-widget'); ?>
            :</label>
          <select name="<?php echo $this->get_field_name('orderby'); ?>"
            ...
            <option value="date"<?php if ($orderby == 'date') {
                echo ' selected';
            } ?>><?php _e('Published Date', 'ultimate-posts-widget'); ?></option>
            <option value="title"<?php if ($orderby == 'title') {
                echo ' selected';
            } ?>><?php _e('Title', 'ultimate-posts-widget'); ?></option>
            <option value="comment_count"<?php if ($orderby == 'comment_count') {
                echo ' selected';
            } ?>><?php _e('Comment Count', 'ultimate-posts-widget'); ?></option>
            <option value="rand"<?php if ($orderby == 'rand') {
                echo ' selected';
            } ?>><?php _e('Random'); ?></option>
            <option value="meta_value"<?php if ($orderby == 'meta_value') {
                echo ' selected';
            } ?>><?php _e('Custom Field', 'ultimate-posts-widget'); ?></option>
            <option value="menu_order"<?php if ($orderby == 'menu_order') {
                echo ' selected';
            } ?>><?php _e('Menu Order', 'ultimate-posts-widget'); ?></option>
          </select>
        </p>

        <p<?php if ($orderby !== 'meta_value') {
            echo ' style="display:none;"';
        } ?>>
          <label for="<?php echo $this->get_field_id('meta_key'); ?>"><?php _e('Custom field',
                  'ultimate-posts-widget'); ?>:</label>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('order'); ?>"><?php _e('Order', 'ultimate-posts-widget'); ?>
            :</label>
          <select name="<?php echo $this->get_field_name('order'); ?>" id="<?php echo $this->get_field_id('order'); ?>"
                  class="widefat">
            <option value="DESC"<?php if ($order == 'DESC') {
                echo ' selected';
            } ?>><?php _e('Descending', 'ultimate-posts-widget'); ?></option>
            <option value="ASC"<?php if ($order == 'ASC') {
                echo ' selected';
            } ?>><?php _e('Ascending', 'ultimate-posts-widget'); ?></option>
          </select>
        </p>
