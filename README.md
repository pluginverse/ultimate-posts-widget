...
See the [FAQ section](#faq) below for documentation on custom templates, hooks, common issues, and more.
...
- Improved template include paths to be more reliable
