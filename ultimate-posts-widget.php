 ...
 */
	...
	add_action('admin_enqueue_scripts', function () {
		...
		$stylURL =  '/' . "css/" . $plugin_prefix . '_notiad.min.css';
		$scriptURL = '/' . "js/". $plugin_prefix . '_notiad.min.js';
	...
	add_action('admin_notices', function () {
		...
		// Link decide
		$link = 'https://bit.ly/2yrFwv5';
		if ($another) $link = 'https://bit.ly/39t5Q4M';

		// Plugins URL
		$url = plugin_dir_url(__FILE__);

		// URL to images folder
		$images = $url . 'assets/' . $plugin_prefix;
				...
				<div id="wpse1_6817_btns">
					...
					<div id="wpse1_6817_other">
						<div id="wpse1_6817_show">
							<a target="_blank" href="<?php echo $link; ?>">See plugin page</a>
						</div>
